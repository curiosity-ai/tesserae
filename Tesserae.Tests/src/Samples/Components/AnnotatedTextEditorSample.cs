...
namespace Tesserae.Tests.Samples
{
    ...
    public class AnnotatedTextEditorSample : IComponent, ISample
    {
        ...
        private static readonly (string Phrase, string Label, string Background, string Color, string Border)[]
            _vocabulary = new[]
            {
                ("Curiosity GmbH", "ORG", "var(--tss-colors-purple-100)", "var(--tss-colors-purple-900)",
                    "var(--tss-colors-purple-500)"),
                ("Curiosity", "ORG", "var(--tss-colors-purple-100)", "var(--tss-colors-purple-900)",
                    "var(--tss-colors-purple-500)"),
                ("Anthropic", "ORG", "var(--tss-colors-purple-100)", "var(--tss-colors-purple-900)",
                    "var(--tss-colors-purple-500)"),
                ("OpenAI", "ORG", "var(--tss-colors-purple-100)", "var(--tss-colors-purple-900)",
                    "var(--tss-colors-purple-500)"),
                ("Microsoft", "ORG", "var(--tss-colors-purple-100)", "var(--tss-colors-purple-900)",
                    "var(--tss-colors-purple-500)"),
                ("Tesserae", "PRODUCT", "var(--tss-colors-blue-100)", "var(--tss-colors-blue-900)",
                    "var(--tss-colors-blue-500)"),
                ("Claude", "PRODUCT", "var(--tss-colors-blue-100)", "var(--tss-colors-blue-900)",
                    "var(--tss-colors-blue-500)"),
                ("GPT-4", "PRODUCT", "var(--tss-colors-blue-100)", "var(--tss-colors-blue-900)",
                    "var(--tss-colors-blue-500)"),
                ("Berlin", "GPE", "var(--tss-colors-green-100)", "var(--tss-colors-green-900)",
                    "var(--tss-colors-green-500)"),
                ("Munich", "GPE", "var(--tss-colors-green-100)", "var(--tss-colors-green-900)",
                    "var(--tss-colors-green-500)"),
                ("San Francisco", "GPE", "var(--tss-colors-green-100)", "var(--tss-colors-green-900)",
                    "var(--tss-colors-green-500)"),
                ("Germany", "GPE", "var(--tss-colors-green-100)", "var(--tss-colors-green-900)",
                    "var(--tss-colors-green-500)"),
                ("Europe", "GPE", "var(--tss-colors-green-100)", "var(--tss-colors-green-900)",
                    "var(--tss-colors-green-500)"),
                ("Alice", "PERSON", "var(--tss-colors-orange-100)", "var(--tss-colors-orange-900)",
                    "var(--tss-colors-orange-500)"),
                ("Bob", "PERSON", "var(--tss-colors-orange-100)", "var(--tss-colors-orange-900)",
                    "var(--tss-colors-orange-500)"),
                ("Jules", "PERSON", "var(--tss-colors-orange-100)", "var(--tss-colors-orange-900)",
                    "var(--tss-colors-orange-500)"),
                ("2024", "DATE", "var(--tss-colors-magenta-100)", "var(--tss-colors-magenta-900)",
                    "var(--tss-colors-magenta-500)"),
                ("2025", "DATE", "var(--tss-colors-magenta-100)", "var(--tss-colors-magenta-900)",
                    "var(--tss-colors-magenta-500)"),
                ("2026", "DATE", "var(--tss-colors-magenta-100)", "var(--tss-colors-magenta-900)",
                    "var(--tss-colors-magenta-500)"),
                ("January", "DATE", "var(--tss-colors-magenta-100)", "var(--tss-colors-magenta-900)",
                    "var(--tss-colors-magenta-500)"),
                ("$1.5 billion", "MONEY", "var(--tss-colors-yellow-100)", "var(--tss-colors-yellow-900)",
                    "var(--tss-colors-yellow-500)"),
                ("$200", "MONEY", "var(--tss-colors-yellow-100)", "var(--tss-colors-yellow-900)",
                    "var(--tss-colors-yellow-500)")
            };
...
Claude and GPT-4 are large language models. Jules built a demo using Tesserae for Microsoft in 2025.";
        ...
        public AnnotatedTextEditorSample()
        {
            ...
            var multiLineTooltipEditor = AnnotatedTextEditor(
                    ...
                    initialText:
                    "Hover \"Curiosity\" for a short multi-line tooltip; hover \"Tesserae\" for a longer one that should wrap. Hover \"ghost\" — its inline highlight is transparent, but the tooltip must stay readable.",
                    debounceMs: 200,
            ...
            _content = SectionStack().Secondary()
                ...
                .FlatSection(VStack().Children(
                    Card(VStack().WS().Children(
                        ...
                        TextBlock("Try editing the text below — entities are re-detected after you pause typing.").MT(8)
                ...
                .FlatSection(VStack().WS().Children(
                    Card(VStack().WS().Children(
                        ...
                        TextBlock(
                                "Every word is wrapped in a gray pill, and the vocabulary matches override the gray with their typed color.")
        ...
        private static async Task<AnnotatedTextEditor.Entity[]> AnnotateAsync(string text)
        {
            ...
            foreach (var v in _vocabulary.OrderByDescending(v => v.Phrase.Length))
            {
                ...
                while (idx < text.Length)
                {
                    ...
                    if (!overlaps)
                    {
                        found.Add(new AnnotatedTextEditor.Entity(found_idx, v.Phrase.Length, v.Label, v.Background,
                            v.Color, v.Border));
                    }
