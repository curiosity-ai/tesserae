        ...
        public ProgressRingSample()
        {
            ...
            _content = SectionStack().Secondary()
               ...
               .FlatSection(Stack().Children(
                    ...
                    HStack().Gap(24).AlignItems(ItemAlign.End).Children(
                    ...
                    HStack().Gap(24).AlignItems(ItemAlign.Center).Children(
                    ...
                    Button("Start 5s countdown").Primary().Var(out var animBtn).OnClick(async () =>
                    {
                        ...
                        var container = HStack().AlignItems(ItemAlign.Center).Gap(12).Children(liveRing, TextBlock("Processing…").Small());
