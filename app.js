 ...
 */
H5.assemblyVersion("Tesserae.Tests","2026.1.63834.0");
H5.assembly("Tesserae.Tests", function ($asm, globals) {
                        ...
                        $ab = H5.fn.bind(this, function () {
                            try {
                                for (;;) {
                                    ...
                                    switch ($s) {
                                        case 0: {
                                            $t1 = System.Threading.Tasks.Task.delay(2000);
                                            $s = 1;
                                            if ($t1.isC()) {
                                                continue;
                                            }
                                ...
                                for (;;) {
                                    ...
                                    switch ($s) {
                                        case 0: {
                                            ...
                                            $t1 = this.GetDetailsListItemsAsync(page, 5);
                                            $s = 1;
                                            if ($t1.isC()) {
                                                continue;
                                            }
                        ...
                        try {
                            for (;;) {
                                ...
                                switch ($s) {
                                    ...
                                    case 1: {
                                        $t1.gAR();
                                        $tcs.sR(System.Array.init([tss.UI.DropdownItem$1("Header 1").Header(), tss.UI.DropdownItem$1("Async Item 1"), tss.UI.DropdownItem$1("Async Item 2"), tss.UI.DropdownItem().Divider(), tss.UI.DropdownItem$1("Header 2").Header(), tss.UI.DropdownItem$1("Async Item 3")], tss.Dropdown.Item));
                                        return;
                                    }
                                    default: {
                                        $tcs.sR(null);
    ...
    H5.define("Tesserae.Tests.Samples.ModalSample", {
        ...
        ctors: {
            ctor: function () {
                ...
                var modal = { };
                var lbl = { };
                tss.LayerExtensions.Content(tss.Modal, tss.ICX.Height(tss.Modal, tss.ICX.Width(tss.Modal, tss.UI.Var(tss.Modal, tss.UI.Modal("Sample Modal"), modal).LightDismiss(), tss.usX.vw$1(60)), tss.usX.vh$1(60)).SetFooter(tss.ITFX.MediumPlus(tss.txt, tss.ITFX.SemiBold(tss.txt, tss.UI.TextBlock("This is a footer note")))), tss.ICTX.Children$6(tss.S, tss.UI.Stack(), [tss.UI.TextBlock("Modals provide a focused environment for users to complete a task or view important information. They can be configured with various options like dark overlays, non-blocking behavior, and draggable headers."), tss.UI.Label$1("Light Dismiss").Inline().AutoWidth().SetContent(tss.UI.Toggle().OnChange(function (s, e) {
    ...
    var $m = H5.setMetadata,
        $n = ["System","System.Collections.Generic","Tesserae","System.Threading.Tasks","Tesserae.Tests.Samples"];
    ...
    } )],"m":[{"a":2,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"GetCards","t":8,"pi":[{"n":"count","pt":$n[0].Int32,"ps":0}],"sn":"GetCards","rt":$n[1].IEnumerable$1(tss.IC),"p":[$n[0].Int32]},{"a":2,"n":"Render","t":8,"sn":"Render","rt":HTMLElement},{"a":1,"n":"_content","t":4,"rt":tss.IC,"sn":"_content","ro":true}]}; }, $n);
    $m("Tesserae.Tests.Samples.ObservableStackSample", function () { return {"nested":[$n[4].ObservableStackSample.StackElement],"att":1048577,"a":2,"at":[H5.apply(new Tesserae.Tests.SampleDetailsAttribute(), {
        Group: "Collections", Order: 0, Icon: 3522
    } )],"m":[{"a":2,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"AddItem","t":8,"sn":"AddItem","rt":$n[0].Void},{"a":1,"n":"Move","t":8,"pi":[{"n":"oldIdx","pt":$n[0].Int32,"ps":0},{"n":"newIdx","pt":$n[0].Int32,"ps":1}],"sn":"Move","rt":$n[0].Void,"p":[$n[0].Int32,$n[0].Int32]},{"a":2,"n":"Render","t":8,"sn":"Render","rt":HTMLElement},{"a":1,"n":"Update","t":8,"pi":[{"n":"idx","pt":$n[0].Int32,"ps":0},{"n":"item","pt":$n[4].ObservableStackSample.StackElement,"ps":1}],"sn":"Update","rt":$n[0].Void,"p":[$n[0].Int32,$n[4].ObservableStackSample.StackElement]},{"a":1,"n":"_content","t":4,"rt":tss.IC,"sn":"_content","ro":true},{"a":1,"n":"_elementIndex","is":true,"t":4,"rt":$n[0].Int32,"sn":"_elementIndex","box":function ($v) { return H5.box($v, System.Int32);}},{"a":1,"n":"_stackElementsList","is":true,"t":4,"rt":tss.ObservableList(tss.ICID),"sn":"_stackElementsList"}]}; }, $n);
    $m("Tesserae.Tests.Samples.ObservableStackSample.StackElement", function () { return {"td":$n[4].ObservableStackSample,"att":1048578,"a":2,"m":[{"a":2,"n":".ctor","t":1,"p":[$n[0].String,$n[0].String],"pi":[{"n":"id","pt":$n[0].String,"ps":0},{"n":"displayName","pt":$n[0].String,"ps":1}],"sn":"ctor"},{"a":2,"n":"Render","t":8,"sn":"Render","rt":HTMLElement},{"a":2,"n":"Color","t":16,"rt":$n[0].String,"g":{"a":2,"n":"get_Color","t":8,"rt":$n[0].String,"fg":"Color"},"fn":"Color"},{"a":2,"n":"ContentHash","t":16,"rt":$n[0].String,"g":{"a":2,"n":"get_ContentHash","t":8,"rt":$n[0].String,"fg":"ContentHash"},"fn":"ContentHash"},{"a":2,"n":"DisplayName","t":16,"rt":$n[0].String,"g":{"a":2,"n":"get_DisplayName","t":8,"rt":$n[0].String,"fg":"DisplayName"},"s":{"a":2,"n":"set_DisplayName","t":8,"p":[$n[0].String],"rt":$n[0].Void,"fs":"DisplayName"},"fn":"DisplayName"},{"a":2,"n":"Id","t":16,"rt":$n[0].String,"g":{"a":2,"n":"get_Id","t":8,"rt":$n[0].String,"fg":"Id"},"s":{"a":2,"n":"set_Id","t":8,"p":[$n[0].String],"rt":$n[0].Void,"fs":"Id"},"fn":"Id"},{"a":2,"n":"Identifier","t":16,"rt":$n[0].String,"g":{"a":2,"n":"get_Identifier","t":8,"rt":$n[0].String,"fg":"Identifier"},"fn":"Identifier"},{"a":1,"backing":true,"n":"<Color>k__BackingField","t":4,"rt":$n[0].String,"sn":"Color"},{"a":1,"backing":true,"n":"<DisplayName>k__BackingField","t":4,"rt":$n[0].String,"sn":"DisplayName"},{"a":1,"backing":true,"n":"<Id>k__BackingField","t":4,"rt":$n[0].String,"sn":"Id"}]}; }, $n);
    ...
    } )],"m":[{"a":2,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"GetItemsAsync","t":8,"sn":"GetItemsAsync","rt":$n[3].Task$1(System.Array.type(tss.Dropdown.Item))},{"a":2,"n":"Render","t":8,"sn":"Render","rt":HTMLElement},{"a":1,"n":"StartLoadingAsyncDataImmediately","is":true,"t":8,"pi":[{"n":"dropdown","pt":tss.Dropdown,"ps":0}],"sn":"StartLoadingAsyncDataImmediately","rt":tss.Dropdown,"p":[tss.Dropdown]},{"a":1,"n":"_content","t":4,"rt":tss.IC,"sn":"_content","ro":true}]}; }, $n);
    ...
    } )],"m":[{"a":2,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"BuildActions","is":true,"t":8,"sn":"BuildActions","rt":$n[1].IEnumerable$1(tss.CommandPaletteAction)},{"a":2,"n":"Render","t":8,"sn":"Render","rt":HTMLElement},{"a":1,"n":"_content","t":4,"rt":tss.IC,"sn":"_content","ro":true}]}; }, $n);
    ...
    $m("Tesserae.Tests.Samples.UIconsSample.IconItem", function () { return {"td":$n[4].UIconsSample,"att":1048579,"a":1,"m":[{"a":2,"n":".ctor","t":1,"p":[$n[2].UIcons,$n[0].String],"pi":[{"n":"icon","pt":$n[2].UIcons,"ps":0},{"n":"name","pt":$n[0].String,"ps":1}],"sn":"ctor"},{"a":2,"n":"IsMatch","t":8,"pi":[{"n":"searchTerm","pt":$n[0].String,"ps":0}],"sn":"IsMatch","rt":$n[0].Boolean,"p":[$n[0].String],"box":function ($v) { return H5.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"Render","t":8,"sn":"Render","rt":tss.IC},{"a":1,"n":"_value","t":4,"rt":$n[0].String,"sn":"_value","ro":true},{"a":1,"n":"component","t":4,"rt":tss.IC,"sn":"component","ro":true}]}; }, $n);
