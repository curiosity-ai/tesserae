 ...
 */
H5.assemblyVersion("Tesserae.Tests","2026.2.63975.0");
                            ...
                            for (;;) {
                                ...
                                switch ($s) {
                                    ...
                                    case 1: {
                                        $t1.gAR();
                                        saveButton.Saving();
                                        $t2 = System.Threading.Tasks.Task.delay(2000);
                                        $s = 2;
                                        if ($t2.isC()) {
                                            continue;
                                        }
                                    ...
                                    case 2: {
                                        $t2.gAR();
                                        saveButton.Saved();
                                        $t3 = System.Threading.Tasks.Task.delay(2000);
                                        $s = 3;
                                        if ($t3.isC()) {
                                            continue;
                                        }
                                    ...
                                    case 3: {
                                        $t3.gAR();
                                        saveButton.NothingToSave();
                                        $t4 = System.Threading.Tasks.Task.delay(2000);
                                        $s = 4;
                                        if ($t4.isC()) {
                                            continue;
                                        }
                    ...
                    var $s = 0,
                        ...
                        $ab = H5.fn.bind(this, function () {
                            for (;;) {
                                ...
                                switch ($s) {
                                    case 0: {
                                        savingToast = tss.UI.SavingToast();
                                        savingToast.Saving("Starting save...");
                                        $t1 = System.Threading.Tasks.Task.delay(2000);
                                        $s = 1;
                                        if ($t1.isC()) {
                    ...
                    $ab = H5.fn.bind(this, function () {
                        try {
                            for (;;) {
                                ...
                                switch ($s) {
                                    case 0: {
                                        toast1 = tss.UI.SavingToast();
                                        toast2 = tss.UI.SavingToast();
                                        toast3 = tss.UI.SavingToast();
                                        toast1.Saving("Starting save...");
                                        toast2.Saving("Starting save...");
                                        toast3.Saving("Starting save...");
                                        $t1 = System.Threading.Tasks.Task.delay(2000);
