 ...
 */
H5.assemblyVersion("Tesserae.Tests","2026.3.65235.0");
H5.assembly("Tesserae.Tests", function ($asm, globals) {
    ...
    H5.define("Tesserae.Tests.App", {
        main: function Main () {
            ...
            sidebar.AddHeader(new Tesserae.SidebarButton.$ctor10("SOURCE_CODE", 696, "Source Code", [new Tesserae.SidebarCommand.$ctor3(218).Tooltip$1("Open repository on GitHub").OnClick(function () {
                ...
                while ($t.moveNext()) {
                    ...
                    try {
                        while ($t1.moveNext()) {
                            ...
                            var sidebarItem = new Tesserae.SidebarButton.$ctor14((item.v.Name || "") + H5.identity(itemIndex, ((itemIndex = (itemIndex + 1) | 0))), item.v.Icon, item.v.Name, [new Tesserae.SidebarCommand.$ctor3(3948).Tooltip$1("Show sample code").OnClick((function ($me, item) {
                                return function () {
    ...
    H5.define("Tesserae.Tests.Samples.NavbarSample", {
        ...
        ctors: {
            ctor: function () {
                ...
                navbar.AddHeader(new Tesserae.SidebarButton.$ctor14("brand", 3486, "My App").Primary());
                navbar.AddHeader(new Tesserae.SidebarButton.$ctor14("dashboard", 1300, "Dashboard"));

                navbar.AddContent(new Tesserae.SidebarButton.$ctor14("profile", 4427, "Profile"));
                navbar.AddContent(new Tesserae.SidebarButton.$ctor14("settings", 3641, "Settings"));
                navbar.AddContent(new Tesserae.SidebarSeparator("sep1"));
                navbar.AddContent(new Tesserae.SidebarButton.$ctor14("logout", 3711, "Logout"));

                navbar.AddFooter(new Tesserae.SidebarButton.$ctor14("footer", 2326, "About"));
    ...
    H5.define("Tesserae.Tests.Samples.OmniBoxSample", {
        ...
        ctors: {
            ctor: function () {
                var $t, $t1;
                this.$initialize();
                var searchModeSample = tss.ICX.WS(tss.OmniBox, tss.UI.OmniBox(($t = new tss.OmniBox.Config(tss.OmniBox.Mode.Search), $t.PlaceholderSearch = "Type something like: potato AND ( tomato OR banana) AND NOT apple", $t))).WithHistory(function () {
                    var $tcs = new H5.TCS();
                    (async () => {
                        {
                    ...
                    return $tcs.task;
                }).OnSearch$1(function (s, q) {
                    var $t1, $t2;
                    tss.UI.Toast().Information(System.String.format("Searched for: {0} (Parsed into {1} tokens)", q.RawQuery, H5.box(($t1 = (($t2 = q.Tokens) != null ? $t2.Count : null), $t1 != null ? $t1 : 0), System.Int32)));
                }).SetSearchText("potato AND ( tomato OR banana) AND NOT apple");

                var chatModeSample = tss.ICX.WS(tss.OmniBox, tss.UI.OmniBox(($t = new tss.OmniBox.Config(tss.OmniBox.Mode.Chat), $t.PlaceholderChat = "Ask me anything", $t))).OnChat$1(function (s, q) {
                    tss.UI.Toast().Information(q.Text);
                });


                var searchAndChatModeSample = tss.ICX.WS(tss.OmniBox, tss.UI.OmniBox(($t = new tss.OmniBox.Config(tss.OmniBox.Mode.SearchAndChat), $t.PlaceholderChat = "Ask me anything", $t.PlaceholderSearch = "Search for anything", $t.ChatFooter = ($t1 = new tss.OmniBox.FooterItems(), $t1.LeftSide = System.Array.init([tss.UI.Dropdown().Searchable().Items$1([tss.UI.DropdownItem$1("Consult Documents", "", 467).Selected(), tss.UI.DropdownItem$1("Find a flight", "", 57), tss.UI.DropdownItem$1("Book a hotel", "", 2243)])], tss.IC), $t1), $t))).OnSearch$1(function (s, q) {
                    var $t2, $t3;
                ...
                this._content = tss.SectionStackX.Section(tss.SectionStackX.Section(tss.SectionStackX.Title(tss.UI.SectionStack(), Tesserae.Tests.Samples.SamplesHelper.SampleHeader("OmniBoxSample")), tss.ICTX.Children$6(tss.S, tss.UI.VStack(), [Tesserae.Tests.Samples.SamplesHelper.SampleTitle("Overview"), tss.ICX.MB(tss.Toggle, toggle, 16), tss.UI.TextBlock("Omnibox provides a powerful input field for switching between a chat and a search interaction. For search, it also provides support for parsing and visual rendering of logical operators like AND, OR, NOT, parenthesis, and quotes.")])), tss.ICTX.Children$6(tss.S, tss.ICX.WS(tss.S, tss.UI.VStack()), [Tesserae.Tests.Samples.SamplesHelper.SampleTitle("Usage"), Tesserae.Tests.Samples.SamplesHelper.SampleSubTitle("Modes"), tss.UI.Label$1("Search").SetContent(searchModeSample), tss.UI.Label$1("Chat").SetContent(tss.ICX.MT(tss.OmniBox, chatModeSample, 6)), tss.UI.Label$1("Search & Chat").SetContent(tss.ICX.MT(tss.OmniBox, searchAndChatModeSample, 6))]));
            }
        },
        methods: {
            Render: function () {
...
{ }})()
                ...
                this._content = tss.SectionStackX.Section(tss.SectionStackX.Section(tss.SectionStackX.Section(tss.SectionStackX.Section(tss.SectionStackX.Section(tss.SectionStackX.Title(tss.UI.SectionStack(), Tesserae.Tests.Samples.SamplesHelper.SampleHeader("SaveButtonSample")), tss.ICTX.Children$6(tss.S, tss.UI.Stack(), [Tesserae.Tests.Samples.SamplesHelper.SampleTitle("Overview"), tss.UI.TextBlock("The SaveButton component is a wrapper around a Button that manages common saving states: Pending, Verifying, Saving, Saved, and Error.")])), tss.ICTX.Children$6(tss.S, tss.UI.Stack(), [Tesserae.Tests.Samples.SamplesHelper.SampleTitle("Manual State Control"), tss.ICTX.Children$6(tss.S, tss.UI.HStack(), [manualButton, tss.ICTX.Children$6(tss.S, tss.UI.Stack(), [tss.UI.Button$1("Set Nothing to Save").OnClick$1(function () {
                ...
                })])), tss.ICTX.Children$6(tss.S, tss.UI.Stack(), [Tesserae.Tests.Samples.SamplesHelper.SampleTitle("Hover State"), tss.UI.TextBlock("This SaveButton has a hover text configured. Hover over it when it is in Pending state."), tss.UI.SaveButton().Configure("Disabled", void 0, void 0, void 0, void 0, "Enable Now!", 4234, 4235, true).Pending()])), tss.ICTX.Children$6(tss.S, tss.UI.Stack(), [Tesserae.Tests.Samples.SamplesHelper.SampleTitle("Dynamic Text Update"), tss.UI.TextBlock("This SaveButton text can be updated dynamically."), this.DynamicTextUpdateSample()])), tss.ICTX.Children$6(tss.S, tss.UI.Stack(), [Tesserae.Tests.Samples.SamplesHelper.SampleTitle("Verifying While"), tss.UI.TextBlock("This button verifies using a custom async task."), this.GetVerifyingWhileButton()]));
            }
        },
        methods: {
            GetVerifyingWhileButton: function () {
                var btn = tss.UI.SaveButton().Pending();
                btn.OnClick(H5.fn.bind(this, function () {
                    (async () => {
                        {
    ...
    H5.define("Tesserae.Tests.Samples.SidebarSample", {
        ...
        ctors: {
            ctor: function () {
                ...
                sidebar.AddContent(new Tesserae.SidebarButton.$ctor14("home", 2216, "Home"));
                sidebar.AddContent(new Tesserae.SidebarButton.$ctor14("profile", 4427, "Profile"));
                ...
                settingsNav.Add(new Tesserae.SidebarButton.$ctor14("general", 3641, "General"));
                settingsNav.Add(new Tesserae.SidebarButton.$ctor14("security", 2581, "Security"));
                settingsNav.Add(new Tesserae.SidebarButton.$ctor14("privacy", 1613, "Privacy"));

                sidebar.AddContent(settingsNav);

                sidebar.AddContent(new Tesserae.SidebarSeparator("sep2"));

                sidebar.AddContent(new Tesserae.SidebarButton.$ctor14("help", 3349, "Help"));
                sidebar.AddContent(new Tesserae.SidebarButton.$ctor6("link", "https://bing.com", 2549, "External Link"));
                ...
                var dotsMenu = new Tesserae.SidebarCommand.$ctor3(2707).OnClickMenu(function () {
                    return System.Array.init([new Tesserae.SidebarButton.$ctor14("MANAGE_ACCOUNT", 4427, "Manage Account"), new Tesserae.SidebarButton.$ctor14("PREFERENCES", 3641, "Preferences"), new Tesserae.SidebarButton.$ctor14("DELETE", 4310, "Delete Account"), new Tesserae.SidebarCommands("EMOTIONS", [new Tesserae.SidebarCommand.$ctor1(9), new Tesserae.SidebarCommand.$ctor1(51), new Tesserae.SidebarCommand.$ctor1(53)]), new Tesserae.SidebarCommands("ADD_DELETE", [new Tesserae.SidebarCommand.$ctor3(3250).Primary(), new Tesserae.SidebarCommand.$ctor3(4310).Danger()]).AlignEnd(), new Tesserae.SidebarButton.$ctor14("SIGNOUT", 3711, "Sign Out")], Tesserae.ISidebarItem);
                });
                ...
                sidebar.AddFooter(new Tesserae.SidebarButton.$ctor11("CURIOSITY_REF", new tss.ImageIcon("/assets/img/curiosity-logo.svg"), "By Curiosity", new Tesserae.SidebarBadge.ctor("+3").Foreground(tss.UI.Theme.Primary.Foreground).Background(tss.UI.Theme.Primary.Background), [new Tesserae.SidebarCommand.$ctor3(218).OnClick(function () {
                    window.open("https://github.com/curiosity-ai/tesserae", "_blank");
    ...
    H5.define("Tesserae.Tests.Samples.SidebarSeparatorSample", {
        ...
        ctors: {
            ctor: function () {
                ...
                sidebar.AddContent(new Tesserae.SidebarButton.$ctor14("1", 2216, "Home"));
                sidebar.AddContent(new Tesserae.SidebarSeparator("sep1"));
                sidebar.AddContent(new Tesserae.SidebarButton.$ctor14("2", 4427, "Profile"));
                sidebar.AddContent(new Tesserae.SidebarSeparator("sep2", "More Options"));
                sidebar.AddContent(new Tesserae.SidebarButton.$ctor14("3", 3641, "Settings"));
    ...
    $m("Tesserae.Tests.Samples.OmniBoxSample", function () { return {"att":1048577,"a":2,"at":[H5.apply(new Tesserae.Tests.SampleDetailsAttribute(), {
        Group: "Components", Order: 21, Icon: 3607
    } )],"m":[{"a":2,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Render","t":8,"sn":"Render","rt":HTMLElement},{"a":1,"n":"_content","t":4,"rt":tss.IC,"sn":"_content","ro":true}]}; }, $n);
