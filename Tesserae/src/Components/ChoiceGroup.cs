...
namespace Tesserae
{
    ...
    public sealed class ChoiceGroup : ComponentBase<ChoiceGroup, HTMLDivElement>, IContainer<ChoiceGroup, ChoiceGroup.Choice>, IBindableComponent<ChoiceGroup.Choice>
    {
        ...
        public ChoiceGroup(string label = "Pick one")
        {
            ...
            InnerElement      = Div(_("tss-choice-group", role: "radiogroup", ariaLabelledBy: headerId, styles: s => { s.flexDirection = "column"; }), h);
        }
        ...
        public sealed class Choice : ComponentBase<Choice, HTMLInputElement>, ITextFormating
        {
            ...
            public Choice(string text)
            {
                ...
                _label       = Label(_("tss-option-container tss-fontcolor-default tss-fontsize-small tss-fontweight-regular", text: text), InnerElement, _radioSpan);
                AttachClick();
                AttachChange();
                AttachFocus();
                AttachBlur();
