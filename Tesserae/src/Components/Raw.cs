...
namespace Tesserae
{
    public class Raw : IComponent, IHasMarginPadding, IHasBackgroundColor
    {
        ...
        public string Background { get => InnerElement.style.background; set { _hasProperties  |= 0b00000001; InnerElement.style.background = value; } }
        public string Margin     { get => InnerElement.style.margin;     set { _hasProperties  |= 0b00000010; InnerElement.style.margin = value; } }
        public string Padding    { get => InnerElement.style.padding;    set { _hasProperties  |= 0b00000100; InnerElement.style.padding = value; } }
        public string Width      { get => InnerElement.style.width;      set { _hasProperties  |= 0b00001000; InnerElement.style.width = value; } }
        public string Height     { get => InnerElement.style.height;     set { _hasProperties  |= 0b00010000; InnerElement.style.height = value; } }
