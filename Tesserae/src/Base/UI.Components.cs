...
namespace Tesserae
{
    ...
    public static partial class UI
    {
        ...
        /// <param name="ifTrue">The component to return if the condition is true.</param>
        /// <param name="ifFalse">The component to return if the condition is false.</param>
        ...
        /// </summary>
        /// <param name="condition">The condition.</param>
        /// <param name="ifTrue">The function that creates the component if the condition is true.</param>
        /// <param name="ifFalse">The component to return if the condition is false.</param>
        /// <returns>The selected component.</returns>
        ...
        /// <param name="condition">The condition.</param>
        /// <param name="ifTrue">The function that creates the component if the condition is true.</param>
        /// <param name="ifFalse">The function that creates the component if the condition is false.</param>
        /// <returns>The selected component.</returns>
        ...
        /// <summary>
        /// Remove a CSS class from the element representing the component.
        /// </summary>
        /// <typeparam name="T">The component type.</typeparam>
        /// <param name="component">The component.</param>
