...
namespace Tesserae
{
    ...
    public static partial class UI
    {
        ...
        /// the same element (see <see cref="Tesserae.TextBlock.BindText(IObservable{string})"/>), so prefer this over
        /// <c>DeferSync(obs, v => TextBlock(v))</c>, which rebuilds the block on every change and flickers.
        /// </summary>
        public static TextBlock TextBlock(IObservable<string> text, bool selectable = false, TextSize textSize = TextSize.Small, TextWeight textWeight = TextWeight.Regular) => new TextBlock(string.Empty, false, selectable, textSize, textWeight).BindText(text);
        /// <summary>
        ...
        /// </summary>
        public static TextBlock TextBlock<T>(IObservable<T> source, Func<T, string> format, bool selectable = false, TextSize textSize = TextSize.Small, TextWeight textWeight = TextWeight.Regular) => new TextBlock(string.Empty, false, selectable, textSize, textWeight).BindText(source, format);
