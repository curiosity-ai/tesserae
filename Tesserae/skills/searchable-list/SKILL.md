...
- `.HideSearchBoxIfLessThan(int)` — hide the box when fewer than N items.
...
- `.Items` — the backing `ObservableList<T>`; mutate to update the list.
...
- SearchableGroupedList — `../searchable-grouped-list/SKILL.md` (grouped variant)
