 Transpose.assembly("Newtonsoft.Json", function ($asm, globals) {
    "use strict";
/**
 * Transpose.Translator generated output.
 */
Transpose.assemblyVersion("Transpose.Newtonsoft.Json", "1.0.0.0");
Transpose.assembly("Transpose.Newtonsoft.Json", function ($asm, globals) {
    "use strict";

    Transpose.define("Newtonsoft.Json.Serialization.IContractResolver", {
        $kind: "interface"
    });

    Transpose.define("Newtonsoft.Json.Serialization.ISerializationBinder", {
        $kind: "interface"
    });

    Transpose.define("Newtonsoft.Json.DefaultValueHandling", {
        $kind: "enum",
        $flags: true,
        statics: {
            fields: {
    ...
    Transpose.define("Newtonsoft.Json.Formatting", {
        $kind: "enum",
        statics: {
            fields: {
                None: 0,
    ...
    Transpose.define("Newtonsoft.Json.JsonConstructorAttribute", {
        inherits: function () { return [System.Attribute]; },
        ctors: {
    ctor: function () {
        this.$initialize();
    ...
    Transpose.define("Newtonsoft.Json.JsonException", {
        inherits: function () { return [System.Exception]; },
        ctors: {
    ctor: function () {
        this.$initialize();
    ...
    Transpose.define("Newtonsoft.Json.JsonIgnoreAttribute", {
        inherits: function () { return [System.Attribute]; },
        ctors: {
    ctor: function () {
        this.$initialize();
    ...
    Transpose.define("Newtonsoft.Json.JsonPropertyAttribute", {
        inherits: function () { return [System.Attribute]; },
        fields: {
    ...
    NullValueHandling: {
        get: function () {
            return (this._nullValueHandling ?? 0);
        },
        set: function (value) {
    ...
    DefaultValueHandling: {
        get: function () {
            return (this._defaultValueHandling ?? 0);
        },
        set: function (value) {
    ...
    ObjectCreationHandling: {
        get: function () {
            return (this._objectCreationHandling ?? 0);
        },
        set: function (value) {
    ...
    TypeNameHandling: {
        get: function () {
            return (this._typeNameHandling ?? 0);
        },
        set: function (value) {
    ...
    Required: {
        get: function () {
            return (this._required ?? Newtonsoft.Json.Required.Default);
        },
        set: function (value) {
    ...
    Transpose.define("Newtonsoft.Json.JsonSerializerSettings", {
        statics: {
    fields: {
    ...
    NullValueHandling: {
        get: function () {
            return (this._nullValueHandling ?? Newtonsoft.Json.JsonSerializerSettings.DefaultNullValueHandling);
        },
        set: function (value) {
            this._nullValueHandling = value;
        }
    ...
    TypeNameHandling: {
        get: function () {
            return (this._typeNameHandling ?? Newtonsoft.Json.JsonSerializerSettings.DefaultTypeNameHandling);
        },
        set: function (value) {
            this._typeNameHandling = value;
        }
    ...
    Transpose.define("Newtonsoft.Json.NullValueHandling", {
        $kind: "enum",
        statics: {
            fields: {
                Include: 0,
    ...
    Transpose.define("Newtonsoft.Json.ObjectCreationHandling", {
        $kind: "enum",
        statics: {
            fields: {
                Auto: 0,
    ...
    Transpose.define("Newtonsoft.Json.Required", {
        $kind: "enum",
        statics: {
            fields: {
                Default: 0,
    ...
    Transpose.define("Newtonsoft.Json.TypeNameHandling", {
        $kind: "enum",
        $flags: true,
        statics: {
            fields: {
    ...
    Transpose.define("Newtonsoft.Json.JsonSerializationException", {
        inherits: function () { return [Newtonsoft.Json.JsonException]; },
        ctors: {
    ctor: function () {
        this.$initialize();
    ...
    Transpose.define("Newtonsoft.Json.Serialization.CamelCasePropertyNamesContractResolver", {
        inherits: function () { return [Newtonsoft.Json.Serialization.IContractResolver]; },
        ctors: {
    ctor: function () {
        this.$initialize();
    }
